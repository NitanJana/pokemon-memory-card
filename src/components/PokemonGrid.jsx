...
export default function PokemonGrid({ pokeData, updateScore, isClicked, setIsClicked, setIsGameOver }) {
  ...
  }, [pokeData, updateScore, isClicked, setIsClicked, setIsGameOver]);
  return (
